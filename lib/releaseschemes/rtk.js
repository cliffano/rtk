  ...
  pre(resources, opts, cb) {
    ...
    resources.forEach(function (resource) {
      function resourceTask(cb) {
        ...
        (require('../resourcetypes/' + resource.type)).setReleaseVersion(self.versionScheme.getReleaseVersion(), resource, opts, cb);
      }
  ...
  post(resources, opts, cb) {
    ...
    resources.forEach(function (resource) {
      function resourceTask(cb) {
        ...
        logger.logStepItem(message);
        (require('../resourcetypes/' + resource.type)).setPostReleaseVersion(self.versionScheme.getPostReleaseVersion(), resource, opts, cb);
      }
      tasks.push(resourceTask);
      paths.push(resource.path);
    });
