...
class Rtk {
  ...
  pre(resources, opts, cb) {
    ...
    resources.forEach(function (resource) {
      function resourceTask(cb) {
        const releaseVersion = resource.params.release_value || self.versionScheme.getReleaseVersion();
  ...
  post(resources, opts, cb) {
    ...
    resources.forEach(function (resource) {
      function resourceTask(cb) {
        const postReleaseVersion = resource.params.post_release_value || self.versionScheme.getPostReleaseVersion();
